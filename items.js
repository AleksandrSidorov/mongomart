...
function ItemDAO(database) {
    ...
    this.getCategories = function(callback) {
        ...
        */
        ...
        var categories = this.db.collection('item').aggregate(
          ...
          docs.unshift({_id: "All", num: allCounter});
          callback(docs);
          //console.log(docs);
        });
    ...
    this.getItems = function(category, page, itemsPerPage, callback) {
        ...
        var pageItems = this.db.collection('item').aggregate(aggrList)
        .toArray(function(err, docs) {
          assert.equal(err, null);
          //console.log(docs);
          callback(docs);
    ...
    this.getNumItems = function(category, callback) {
         ...
         */
         ...
         var categories = this.db.collection('item').aggregate(aggrList)
         .toArray(function(err, docs) {
           assert.equal(err, null);
           assert.notEqual(docs.length, 0);
         ...
         //var cats = this.getCategories(categories);
         //console.log(cats);
